...
def getData(filename):
    ...
    if( os.path.exists('./'+filename)):
        ...
        ## Trexw to keimeno.Gia kathe paper pairnw tis anafores 
        ## kai ston pinaka pou krataw tis xronologies gia to kathe paper 
        ## vazw thn xronologia tou trexwn paper
        ...
        ## filtrarw osa paper exoune citations 
        for i in range(0,len(finalYears)):
            if(len(finalYears[i])>0): #[2008,2007,2008]
